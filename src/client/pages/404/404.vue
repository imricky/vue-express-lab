<template>
  <div class="notfoud-container">
    ...
    <div class="notfound-btn-container">
      <a class="notfound-btn" @click="reload">返回首页</a>
    </div>
  </div>
</template>
...
<style>
  *{padding:0;margin:0}a{text-decoration:none}
  .notfoud-container .img-404{
    height:205px;
    background:url('../../Resources/cool-background.jpg') center center no-repeat;
    -webkit-background-size:200px auto;margin-top:40px;margin-bottom:20px
  }
